jQuery(function () {
    function Anima(name, px) { // version 2.9
        ...
        this.spanCss = function (transform, transition) {        
            ...
            this.spanAnimaCss(transform, transition, 0);
        };
        
        this.spanAnimaCss = function (transform, transition, opacity) {
        ...
        this.sspan = function (replay) { //true - с повтором
            ...
            if (!x.prop("shown") && this.isVisible(this.px)) { //видно
	            ...
	            this.spanAnimaCss('none', this.spanTransition, 1);
	        }else{
		        if(replay){
			         this.spanAnimaCss(this.spanTransform, this.spanTransition, 0);
		        }
	        }
        };
